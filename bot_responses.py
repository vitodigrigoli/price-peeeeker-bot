responses = {
	'it': {
		'robot_friendly':{
			...
			"premium_activate": "<strong>COME ATTIVARE LA VERSIONE PREMIUM </strong>\n\n1️⃣ Invia l'importo dell'abbonamento scelto a https://www.paypal.me/vitodigrigoli \n\n<em>Abbonamento Annuale: {annual_price}€\nAbbonamento a Vita: {lifetime_price}€</em>\n\n 2️⃣ Usa come messaggio il testo:\n\n<pre>Premium {user_ID}</pre>\n\n3️⃣ Apri il nostro bot di supporto https://t.me/ReportPricePeekerBot se hai bisogno di aiuto o per avvisare del pagamento effettuato.\n\n4️⃣ L'attivazione della modalità PREMIUM avverrà entro le 24 ore🌟",
		...
		'dark_wizard': {
			...
			"premium_activate": "<strong>COME EVOCARE LA VERSIONE PREMIUM </strong>\n\n1️⃣ Offri il tributo per l'abbonamento scelto a https://www.paypal.me/vitodigrigoli \n\n<em>Abbonamento Annuale: {annual_price}€\nAbbonamento a Vita: {lifetime_price}€</em>\n\n 2️⃣ Usa come messaggio il testo:\n\n<pre>Premium {user_ID}</pre>\n\n3️⃣ Apri il portale del nostro bot di supporto https://t.me/ReportPricePeekerBot se hai bisogno di aiuto o per avvisare del pagamento effettuato.\n\n4️⃣ L'attivazione della modalità PREMIUM avverrà entro le 24 ore🌟",
		...
		'merchant_viking':{
			...
			"premium_activate": "<strong>COME ATTIVARE LA VERSIONE PREMIUM </strong>\n\n1️⃣ Invia l'oro per l'abbonamento scelto a https://www.paypal.me/vitodigrigoli \n\n<em>Abbonamento Annuale: {annual_price}€\nAbbonamento a Vita: {lifetime_price}€</em>\n\n 2️⃣ Usa come messaggio il testo:\n\n<pre>Premium {user_ID}</pre>\n\n3️⃣ Apri il nostro corvo messaggero https://t.me/ReportPricePeekerBot se hai bisogno di aiuto o per avvisare del pagamento effettuato.\n\n4️⃣ L'attivazione della modalità PREMIUM avverrà entro le 24 ore🌟",
